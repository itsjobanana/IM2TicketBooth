    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberOfSeats', models.IntegerField()),
                ('status', models.BooleanField(default=False)),
                ('roomType', models.CharField(max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Concert',
            fields=[
                ...
                ('concertName', models.CharField(max_length=50)),
                ('artist', models.CharField(max_length=50)),
                ('venue', models.CharField(max_length=50)),
                ('concertDate', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date.today)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(default=models.CharField(choices=[('V', 'VIP'), ('R', 'Regular')], max_length=1))),
        ...
        migrations.AddField(
            model_name='concert',
            name='user',
            field=models.ManyToManyField(related_name='attend', through='registration.BookingC', to='registration.customer'),
        ),
        migrations.AddField(
            model_name='bookingc',
            name='concertUser',
